...
### Showcased at the European Week of Regions and Cities 2025

We're proud to share that the **Cohesion Open Data Platform** was featured at the [European Week of Regions and Cities (EWRC) 2025](https://regions-and-cities.europa.eu/programme/2025/sessions/58100) — the EU's flagship event for regional policy and innovation.

During the session **"Cohesion Open Data Platform – A Key Resource for Cohesion and Data Enthusiasts"**, representatives from the **European Commission's Directorate-General for Regional and Urban Policy (DG REGIO)** presented and demonstrated the platform to a live audience of policymakers, journalists, and data professionals.

> "Our platform was highlighted as a core tool for transparency and data-driven cohesion policy across Europe."

This recognition reflects our commitment to building high-impact, scalable open data systems that empower public institutions and citizens alike. We're honored that our work continues to support the European Commission's vision for open, accessible, and evidence-based policymaking.

<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div>
    <img src="/images/case-studies/eu-cohesion/ewrc-2025-presentation-1.jpg" alt="DG REGIO presenting the Cohesion Open Data Platform at European Week of Regions and Cities 2025" />
  </div>
  <div>
    <img src="/images/case-studies/eu-cohesion/ewrc-2025-presentation-2.jpg" alt="DG REGIO representative showcasing platform achievements and features at EWRC 2025" />
  </div>
</div>

*DG REGIO's presentation of the Cohesion Open Data Platform at EWRC 2025, showcasing features and achievements built by our team.*
